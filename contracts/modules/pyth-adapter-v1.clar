...
(define-constant PRICE_DECIMALS (to-int (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.constants-v2 get-price-decimals)))
...
(define-public (update-price-feed-id (token principal) (new-feed-id uint) (max-confidence-ratio uint))
  (begin
    (asserts! (is-eq (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 get-governance) contract-caller) ERR-NOT-AUTHORIZED)
