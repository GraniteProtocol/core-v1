...
(define-read-only (get-market-state)
  (let (
    ...
    (total-staked-shares (unwrap! (contract-call? 'SP3G0BKE829S65ZN2DMED2KZ032V7Y30S01AD7CAD.staking-v1 get-total-supply ) ERR-FAILED-TO-GET-BALANCE))
    (active-staked-lp-tokens (contract-call? 'SP3G0BKE829S65ZN2DMED2KZ032V7Y30S01AD7CAD.staking-v1 get-active-staked-lp-tokens ))
    (total-staked-lp-tokens (contract-call? 'SP3G0BKE829S65ZN2DMED2KZ032V7Y30S01AD7CAD.staking-v1 get-total-staked-lp-tokens )))
