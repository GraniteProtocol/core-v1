...
(define-public (finalize-unstake (index uint))
  (let (
    ...
    (if (not (var-get staking-wiped-out))
      ...
      (var-set unfinalized-withdrawals {
        lp-tokens: (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.math-v1 safe-sub (get lp-tokens unfinalized-withdrawal-info) lp-tokens-to-return),
        shares: (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.math-v1 safe-sub (get shares unfinalized-withdrawal-info) withdraw-shares),
      })
    )
