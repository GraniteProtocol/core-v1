...
(define-private (execute-state-governance-update (proposal-id (buff 32)))
  (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 update-governance (unwrap-panic (map-get? update-governance-proposal-data proposal-id)))
)
...
(define-private (execute-state-set-feature-flag (proposal-id (buff 32)) (action uint))
  (let (
    ...
    (asserts! (not (is-eq action ACTION_SET_DEPOSIT_ASSET_FLAG)) (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-deposit-asset-flag flag))
    (asserts! (not (is-eq action ACTION_SET_WITHDRAW_ASSET_FLAG)) (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-withdraw-asset-flag flag))
    (asserts! (not (is-eq action ACTION_SET_ADD_COLLATERAL_FLAG)) (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-add-collateral-flag flag))
    (asserts! (not (is-eq action ACTION_SET_REMOVE_COLLATERAL_FLAG)) (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-remove-collateral-flag flag))
    (asserts! (not (is-eq action ACTION_SET_BORROW_FLAG)) (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-borrow-flag flag))
    (asserts! (not (is-eq action ACTION_SET_REPAY_FLAG)) (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-repay-flag flag))
    (asserts! (not (is-eq action ACTION_SET_LIQUIDATION_FLAG)) (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-liquidation-flag flag cooldown))
    (asserts! (not (is-eq action ACTION_SET_INTEREST_ACCRUAL_FLAG)) (begin
      (try! (accrue-interest))
      (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-interest-accrual-flag flag)))
    ERR-INVALID-ACTION
))
...
(define-private (execute-state-set-market-flag (proposal-id (buff 32)) (action uint))
  (let ((cooldown (unwrap-panic (map-get? unpause-market-data proposal-id))))
    (asserts! (not (is-eq action ACTION_SET_MARKET_PAUSE_FLAG)) (begin
      (try! (accrue-interest))
      (try! (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 pause-market))
      (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-staking-flag false)))
    (asserts! (not (is-eq action ACTION_SET_MARKET_UNPAUSE_FLAG)) (begin 
      (try! (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 unpause-market cooldown))
      (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-staking-flag true)))
    ERR-INVALID-ACTION
))
...
(define-private (execute-state-update-collateral-settings (proposal-id (buff 32)))
  (let ((settings (unwrap-panic (map-get? collateral-settings-proposal-data proposal-id))))
    (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 update-collateral-settings
...
(define-private (execute-state-reserve-action (proposal-id (buff 32)) (action uint))
  (let ((amount (unwrap-panic (map-get? reserve-proposal-data proposal-id))))
    (asserts! (not (is-eq action ACTION_DEPOSIT_TO_RESERVE)) (as-contract (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 deposit-to-reserve amount)))
    (asserts! (not (is-eq action ACTION_WITHDRAW_FROM_RESERVE)) (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 withdraw-from-reserve amount))
    ERR-INVALID-ACTION
))
...
(define-private (execute-state-set-allowed-contract (proposal-id (buff 32)) (action uint))
  (let ((allowed-contract (unwrap-panic (map-get? allowed-contract-data proposal-id))))
    (asserts! (not (is-eq action ACTION_SET_ALLOWED_CONTRACT)) (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-allowed-contract allowed-contract))
    (asserts! (not (is-eq action ACTION_REMOVE_ALLOWED_CONTRACT)) (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 remove-allowed-contract allowed-contract))
    ERR-INVALID-ACTION
))
...
(define-private (execute-protocol-reserve-percentage (proposal-id (buff 32)))
  (let ((reserve-value (unwrap-panic (map-get? protocol-reserve-percentage proposal-id))))
    (try! (accrue-interest))
    (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-protocol-reserve-percentage reserve-value)
))
...
(define-private (execute-update-asset-cap (proposal-id (buff 32)))
  (let ((asset-cap (unwrap-panic (map-get? asset-cap-update proposal-id))))
    (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 update-asset-cap asset-cap)
))
...
(define-private (execute-update-reward-rate-params (proposal-id (buff 32)))
  (let ((reward-data (unwrap-panic (map-get? update-reward-rate-params proposal-id))))
    (try! (accrue-interest))
    (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.staking-reward-v1 update-reward-params
...
(define-private (execute-freeze-upgrades)
  (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 freeze-upgrades)
)
...
(define-private (execute-remove-collateral (proposal-id (buff 32)))
  (let ((collateral (unwrap-panic (map-get? remove-collateral proposal-id))))
    (try! (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 remove-collateral collateral))
    SUCCESS
))
...
(define-private (execute-set-staking-flag (proposal-id (buff 32)))
  (let ((status (unwrap-panic (map-get? staking-flag proposal-id))))
    (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-staking-flag status)
))
...
(define-private (accrue-interest)
  (let (
      (accrue-interest-params (unwrap! (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 get-accrue-interest-params) ERR-INTEREST-RATE-PARAMS))
...
(define-public (guardian-pause-market)
  (begin
    ...
    (try! (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 pause-market))
    (try! (contract-call? 'SP3M2BYF7RGF8WKW5FVDNJ6WR8D7AR9BHDXAKPXZE.state-v1 set-staking-flag false))
    SUCCESS
))
