  ...
  (begin
    ...
    (let
      (
        ...
        (lp-open-interest-without-principal (contract-call? 'SP35E2BBMDT2Y1HB0NTK139YBGYV3PAPK3WA8BRNA.math-v1 safe-sub (get lp-open-interest interest-params) total-borrowed-amount))
